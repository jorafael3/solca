                    ...
                    <div class="card-body">
                        ...
                        <span class="svg-icon svg-icon-white svg-icon-3x ms-n1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                                ...
                                <path fill="black" fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z" />
            ...
            <div class="col-xl-6">
                ...
                <a href="#" class="card hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-800 fw-bolder fs-2 mb-2 mt-5"><?php echo $resumen[0]["areas"] ?></div>
                        <div class="fw-bold text-gray-700 fs-2">Areas</div>
                    </div>
                    <!--end::Body-->
                </a>
                <!--end::Statistics Widget 5-->
                        ...
                        <div class="card-px pt-1 pb-1 flex-grow-1">
                            ...
                            <div class="row g-0 mt-0 mb-5 pt-5">
                                <div class="table-responsive">
                                    <table id="DSA_TABLA_ATENCION_SERVICIO" class="display fs-5 table table-striped table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                        <thead>
                                            <tr>
