...
<div class="row gy-5 g-xl-10">
            ...
            <div class="card-body row">
                <div class="col-12 row">
                    ...
                    <div class="col-12">
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            <div class="mb-10">
                                <label for="exampleFormControlInput1" class="required form-label">Objetivo Estrategico</label>
                                <select id="REP_OBJ_EST" type="text" class="form-control form-control-solid" placeholder="modelo">
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-12" style="display: none;" id="SECCCION_POR_PROYECTO">
        <div class="card shadow-sm">
            <div class="card-body">
