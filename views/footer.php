                       ...
                       <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                           <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                               <div class="text-dark order-2 order-md-1">
                                   ...
                                   <img  src="<?php echo constant("URL") ?>public/assets/images/softlogo.png" alt="">
                               </div>
                       ...
                       <script src="<?php echo constant('URL') ?>public/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
                       <script src="<?php echo constant('URL') ?>public/assets/plugins/custom/datatables/datatables.bundle.js"></script>
                       <!--end::Page Vendors Javascript-->
                       <!--begin::Page Custom Javascript(used by this page)-->
                       <script src="<?php echo constant('URL') ?>public/assets/js/widgets.bundle.js"></script>
                       <script src="<?php echo constant('URL') ?>public/assets/js/custom/widgets.js"></script>
                       <script src="<?php echo constant('URL') ?>public/assets/js/custom/apps/chat/chat.js"></script>
